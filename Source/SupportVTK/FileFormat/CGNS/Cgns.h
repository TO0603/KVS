...
public:
     ...
     */
    kvs::vtk::detail::VtkMultiBlockContainer<vtkMultiBlockDataSet> eachBlock()
    {
        return kvs::vtk::detail::VtkMultiBlockContainer<vtkMultiBlockDataSet>( vtk_data );
    }
    /**
     * Get an interface to iterate each block.
     *
     ...
     * \return An interface to iterate.
     */
    kvs::vtk::detail::VtkMultiBlockContainer<vtkMultiBlockDataSet> eachBlock() const
    {
        return kvs::vtk::detail::VtkMultiBlockContainer<vtkMultiBlockDataSet>( vtk_data );
    }
