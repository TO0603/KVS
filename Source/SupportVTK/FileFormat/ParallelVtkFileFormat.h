...
public:
     ...
     */
    kvs::vtk::detail::VtkPieceContainer<PieceFileFormatType, VtkReaderType> eachPiece()
    {
        return kvs::vtk::detail::VtkPieceContainer<PieceFileFormatType, VtkReaderType>(
     ...
     * \return An interface to iterate each piece.
     */
    kvs::vtk::detail::VtkPieceContainer<PieceFileFormatType, VtkReaderType> eachPiece() const
    {
        return kvs::vtk::detail::VtkPieceContainer<PieceFileFormatType, VtkReaderType>(
            m_number_of_pieces, reader );
    }
