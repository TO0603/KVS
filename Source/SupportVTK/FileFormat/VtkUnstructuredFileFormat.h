...
public:
    kvs::vtk::detail::CellTypeIterator<BaseClass> begin()
    {
        return kvs::vtk::detail::CellTypeIterator<BaseClass>( cell_types.cbegin(), data );
    }
    kvs::vtk::detail::CellTypeIterator<BaseClass> begin() const
    {
        return kvs::vtk::detail::CellTypeIterator<BaseClass>( cell_types.begin(), data );
    }
    kvs::vtk::detail::CellTypeIterator<BaseClass> end()
    {
        return kvs::vtk::detail::CellTypeIterator<BaseClass>( cell_types.cend(), data );
    }
    kvs::vtk::detail::CellTypeIterator<BaseClass> end() const
    {
        return kvs::vtk::detail::CellTypeIterator<BaseClass>( cell_types.end(), data );
    }
...
class VtkUnstructuredFileFormat
    : public kvs::vtk::VtkFileFormat<VtkDataType, VtkReaderType, VtkWriterType>
{
public:
    /**
     * A base class type.
     */
    using BaseClass = kvs::vtk::VtkFileFormat<VtkDataType, VtkReaderType, VtkWriterType>;
...
public:
     ...
     */
    kvs::vtk::detail::CellTypeContainer<
        VtkUnstructuredFileFormat<VtkDataType, VtkReaderType, VtkWriterType>>
    eachCellType()
    {
        return kvs::vtk::detail::CellTypeContainer<
            VtkUnstructuredFileFormat<VtkDataType, VtkReaderType, VtkWriterType>>(
