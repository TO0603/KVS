...
void kvs::vtk::detail::ImportPolygonObject( kvs::PolygonObject* polygon_object,
                                       ...
                                       vtkSmartPointer<vtkUnstructuredGrid> data )
{
    ...
    kvs::vtk::detail::ImportPolygonObject( polygon_object, polydata );
}

void kvs::vtk::detail::ImportRectilinearObject( kvs::StructuredVolumeObject* rectilinear_object,
...
void kvs::vtk::detail::ImportUniformStructuredVolumeObject( kvs::StructuredVolumeObject* uniform_object,
...
void kvs::vtk::detail::ImportIrregularStructuredVolumeObject(
...
void kvs::vtk::detail::ImportUnstructuredVolumeObject( kvs::UnstructuredVolumeObject* object,
                                                  vtkSmartPointer<vtkUnstructuredGrid> data )
{
...
void kvs::vtk::detail::ImportPointObject( kvs::PointObject* object,
                                     vtkSmartPointer<vtkUnstructuredGrid> data )
{
    auto coords = GetCoordinates( data );
    object->setCoords( coords );
...
void kvs::vtk::detail::ImportLineObject( kvs::LineObject* object,
                                    vtkSmartPointer<vtkUnstructuredGrid> data )
{
