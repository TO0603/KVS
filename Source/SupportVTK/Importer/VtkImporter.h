 ...
 */
template <typename VtkFileFormat, typename KvsObjectType_ = typename kvs::vtk::ConvertibleTypeTraits<
...
public:
    kvs::ObjectBase* exec( const kvs::FileFormatBase* file_format )
    {
        ...
        try
        {
            kvs::vtk::Import<
                KvsObjectType*,
                vtkSmartPointer<typename kvs::vtk::VtkFileFormatTraits<VtkFileFormat>::VtkDataType>>(
