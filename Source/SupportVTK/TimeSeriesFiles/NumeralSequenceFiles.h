...
public:
     ...
     */
    kvs::vtk::detail::NumeralSequenceFileIterator<FileFormat> begin()
    {
        return kvs::vtk::detail::NumeralSequenceFileIterator<FileFormat>( filenames );
    }
    /**
     * Return a file format iterator to the beginning.
     *
     * \return A file format iterator.
     */
    kvs::vtk::detail::NumeralSequenceFileIterator<FileFormat> begin() const
    {
        return kvs::vtk::detail::NumeralSequenceFileIterator<FileFormat>( filenames );
    }
    /**
     ...
     * \return A file format iterator.
     */
    kvs::vtk::detail::NumeralSequenceFileIterator<FileFormat> end()
    {
        return kvs::vtk::detail::NumeralSequenceFileIterator<FileFormat>(
     ...
     * \return A file format iterator.
     */
    kvs::vtk::detail::NumeralSequenceFileIterator<FileFormat> end() const
    {
        return kvs::vtk::detail::NumeralSequenceFileIterator<FileFormat>(
            filenames, filenames->GetNumberOfValues() );
    }
 ...
 * kvs::vtk::NumeralSequenceFiles<SomeFileFormat> n( pattern );
...
public:
     ...
     */
    kvs::vtk::detail::NumeralSequenceFileContainer<FileFormat> eachTimeStep()
    {
        return kvs::vtk::detail::NumeralSequenceFileContainer<FileFormat>( filenames );
    }
    /**
     * Get an interface to iterate time series files.
     *
     * \return An interface to iterate time series files.
     */
    kvs::vtk::detail::NumeralSequenceFileContainer<FileFormat> eachTimeStep() const
    {
        return kvs::vtk::detail::NumeralSequenceFileContainer<FileFormat>( filenames );
    }
